...
# Data
test_x, test_y = iris_x[:, test_indices], iris_y[:, test_indices]

train_x, train_y = iris_x[:, train_indices], iris_y[:, train_indices]
...
# Training
@Flux.epochs 110 Flux.train!(loss, params(model), train_iterator, opt,
